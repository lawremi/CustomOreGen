...
/**
 * Exposes functions for rendering Mystcraft elements, such as symbols, words,
 * and colors
 * 
 * @author xcompwiz
 */
...
public interface IRenderAPI {
     ...
     * @param zLevel
     *        The zLevel we're drawing on
     * @param scale
     *        The size in pixels of the square
     * @param symbol
     *        The symbol to draw
     */
    ...
    /**
     * Draws a Narayan word from the word list. If the word does not exist, it
     * will be generated based on the string.
     * Note that you can also draw D'ni numbers by using for example "1" as the
     * word. This works for 0-26.
     * 
     * @param x
     *        The x location in pixels
     * @param y
    ...
    /**
     * Draws a D'ni color "eye". The eye will be in and represent the provided
     * color.
     * 
     * @param x
     *        The x location in pixels
     ...
     *        The size in pixels of the square
     * @param color
     *        The color object to use when drawing the eye
     */
