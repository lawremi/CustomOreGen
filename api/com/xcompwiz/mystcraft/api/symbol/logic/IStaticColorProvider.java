...
public interface IStaticColorProvider {
     ...
     * Note that the produced color is fixed, so this type of element should not
     * use gradients
     * Can return null if the logic element does not provide a color for this
     * case
     * 
     * @param type
     *        String identifier of the type of color
     * @param worldObj
     *        The world object
     * @param biome
     *        The current biome. Can be null
