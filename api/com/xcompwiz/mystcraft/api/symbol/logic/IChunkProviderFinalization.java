...
/**
 * Allows for cleanup and finalization tasks to happen to the chunk before
 * population occurs
 * This is the last step of the chunk creation
 * Can be used, for example, to alter the biomes in the chunk or to build some
 * form of data structures.
 * 
 * @author xcompwiz
 */
public interface IChunkProviderFinalization {
    ...
    /**
     * Called right after the chunk object has been built, but before population
     * happens
     * 
     * @param chunk
     *        The chunk object
