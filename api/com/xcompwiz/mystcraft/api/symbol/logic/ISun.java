...
public interface ISun {
    ...
    /**
     * Returns the position in the period of the (light-giving) celestial body,
     * assuming it cycles
     * 0 is noon, 0.5 is midnight
     * As the object progresses thought the sky, the number increases. At
     * midnight it reaches 0.5, after which it continues increasing until it
     * reaches noon, where it loops back to 0.
     * 
    ...
    /**
     * Returns the number of ticks until this solar object is at 0.75 (celestial
     * period position)
