 ...
 * You can, of course, create your own words, but it is recommended that you use
 * this list for the most part and only create words as necessary
 * If you use a word in a poem but do not define the draw components for the
 * word then the system will automatically deterministically generate components
 * for the word.
 * 
