...
/**
 * A basic algebra math formula interface for calculating the instability to
 * produce when using a block descriptor.
 * 
 * @author xcompwiz
 */
public interface IInstabilityFormula {
     ...
     *        The average number of clusters per chunk. 0 implies a single
