...
public final class BlockCategory {
     ...
     * Generally you shouldn't make more than one instance with a name, but it
     * is supported for the sake of multiple add-ons wanting identical new block
     * types
     * 
     * @param name
     *        The name of the category. Used for comparisons and as the
     *        category's grammar token
     */
