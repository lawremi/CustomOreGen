...
public interface ILinkingAPI {
     ...
     *        The entity to link
     * @param linkinfo
     *        The link destination and information
     * @return True if the link is permitted.
     */
    boolean isLinkAllowed(Entity entity, ILinkInfo linkinfo);

    /**
     * Attempts to link (Teleport) the entity using the information provided by
     * the link info object.
     * Any mounted or riding entities will be linked as well.
     * This is not guaranteed to succeed.
     * Note that the link can fail on individual entities in a mount chain but
     * succeed on part of it (the rider may link without the mount, for
     * example).
     * 
     * @param entity
     *        The entity to link
     * @param linkinfo
     *        The link destination and information. A valid link info object can
     *        be created using the other functions from this interface.
     */
     ...
     * @param Entity
     *        An entity which holds the position and orientation desired. Can be
     *        a dummy/fake entity.
     ...
     * spawn).
     * This is primarily meant for use in conjunction with ILinkInfo's
     * conversion to NBT function.
     * 
     * @param linkInfo
     *        The link destination and information in NBT. This can be obtained
     *        from an ILinkInfo object.
     * @return The Link's descriptor. You can modify the link's properties
     *         through this.
     */
     ...
     * 
     * @param worldObj
     *        The world object of the dimension to get the unique link id for
