 ...
 * instability mechanics to Mystcraft
 */
public interface IInstabilityProvider {
     ...
     * 
     * @return The amount of stability to provide every time this mechanic is
     *         added
     */
     ...
     * can be added.
     * The mechanic will only be added to a world if the world's instability
     * score is less than or equal to this value.
     ...
     * controller.
     * This will be called only once during age construction, no matter what
     * level the provider is for the world (regardless of the number of times
     * 'stacked').
     * 
     * @param level
    ...
    /**
     * Should return the maximum level of the mechanic, ie. the number of times
