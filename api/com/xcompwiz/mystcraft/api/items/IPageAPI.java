...
public interface IPageAPI {
    ...
    /**
     * Returns the link properties of the page. Returns an empty list if no
     * properties, or null if not a link panel.
     * 
     * @param page
     *        The page to query
     * @return Null is not a linking panel, otherwise a list of all the link
     *         properties on the panel. The list may be empty.
     */
    ...
    /**
     * Gets the symbol identifier on a page. Returns null if there is not symbol
     * on the page.
     * 
     * @param page
     *        The page to query
     ...
     *        The page to affect
     * @param symbol
     *        The identifier of the symbol to apply
     */
