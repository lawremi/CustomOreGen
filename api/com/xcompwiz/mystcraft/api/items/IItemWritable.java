...
public interface IItemWritable extends IItemRenameable {
     ...
     * @param itemstack
     *        The itemstack instance of the item being written to
     * @param symbol
     *        The id of the symbol being written
     * @param paper_feeder
     *        This is an itemstack of paper. You may decrease the stack size to
     *        "use" paper. May be null.
