...
/**
 * This interface allows you to create your own items which the Mystcraft
 * writing desk can use as symbol sources (the tabs on the left).
 * Have your items implement it to allow the desk to get symbols from them for
 * writing.
 * 
 * @author xcompwiz
 */
public interface IItemSymbolProvider extends IItemRenameable {
     ...
     * 
     * @param player
     *        The player getting the page
     * @param itemstack
     *        The itemstack instance of the item the page is being removed from
     * @param index
     *        The slot index of the page. This is the slot id provided by your
     *        PositionableItem instances
     * @return The page retrieved as an itemstack
     */
    ItemStack removePage(EntityPlayer player, ItemStack itemstack, int index);

    /**
     * Called to retrieve the list of pages and their locations in the
     * itemstack.
     ...
     *        The current player
     * @param itemstack
     *        The itemstack instance of this item
     ...
     * This method is typically done by the "on tab" drop, rather than to the
     * surface.
     * If you do not wish to accept the page, simply return the page.
     * 
     * @param player
     *        The player adding the page
     * @param itemstack
     *        The itemstack instance of this item
     * @param page
     *        The page being added. Not guaranteed to be a page item. May have
     *        stacksize > 1.
     * @return The reject of the operation. The player's cursor item will be set
     *         to this.
     */
    ...
    /**
     * Called when the player tries to add a page to the itemstack.
     * This method is typically called when the player clicks somewhere on the
     * surface with an item in hand.
     * If you do not wish to accept the page, simply return the page.
     * 
     * @param player
     *        The player adding the page
     ...
     * Only the positions need to be changed, the slot numbers may remain the
     * same.
     ...
     * @param width
     *        The width of the surface area you are fitting your items into
     */
