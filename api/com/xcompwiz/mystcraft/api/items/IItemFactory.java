...
public interface IItemFactory {
     ...
     * Note, this succeeds even if the symbol is not a properly registered
     * symbol
     * 
     * @param identifier
    ...
    /**
     * Builds a notebook containing pages for all of the symbols produced
     * directly from the provided grammar tokens
     * 
     * @param name
     *        The name of the notebook
     * @param tokens
     *        The list of grammar tokens to expand for symbols
     ...
     *        The name of the notebook
     * @param pages
     *        The list of page itemstacks to add
     * @return The notebook itemstack
     */
