...
public class TouchingDescriptor {
	...
	private static HashSet<BlockPos> getPositionMapConstant(TouchingContactType contactType) {
		switch (contactType) {
		default:
		case Face: return positionMapContactTypeFace;
		case Edge: return positionMapContactTypeEdge;
		case Vertex: return positionMapContactTypeVertex;
		case Any: return positionMapContactTypeAny;
		case FaceAndEdge: return positionMapContactTypeFaceAndEdge;
		}
	}
	...
	private static HashSet<BlockPos> getPositionMapConstant(TouchingDirection direction) {
		switch (direction) {
		default:
		case Any: return positionMapDirectionAny;
		case North: return positionMapDirectionNorth;
		case East: return positionMapDirectionEast;
		case South: return positionMapDirectionSouth;
		case West: return positionMapDirectionWest;
		case Up: return positionMapDirectionUp;
		case Down: return positionMapDirectionDown;
		case NorthSouth: return positionMapDirectionNorthSouth;
		case EastWest: return positionMapDirectionEastWest;
		case Vertical: return positionMapDirectionVertical;
		case Horizontal: return positionMapDirectionHorizontal;
		}
	}
