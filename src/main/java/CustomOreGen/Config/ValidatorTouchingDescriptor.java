...
public class ValidatorTouchingDescriptor extends ValidatorBlockDescriptor {
    ...
    protected boolean validateChildren() throws ParserException {
        ...
        if (this.minimumTouches < MINIMUM_TOUCHES || this.minimumTouches > MAXIMUM_TOUCHES) {
            throw new ParserException("'minimumTouches' must be between " + Integer.toString(MINIMUM_TOUCHES) + " and "
                    + Integer.toString(MAXIMUM_TOUCHES) + " inclusive.", this.getNode());
        }
        ...
        if (this.maximumTouches < MINIMUM_TOUCHES || this.maximumTouches > MAXIMUM_TOUCHES) {
            throw new ParserException("'maximumTouches' must be between " + Integer.toString(MINIMUM_TOUCHES) + " and "
                    + Integer.toString(MAXIMUM_TOUCHES) + " inclusive.", this.getNode());
        }
