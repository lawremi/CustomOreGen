    ...
    public class VertexBuffer
    {
        ...
        public void drawBuffer()
        {
            ...
            if (this.renderMode >= 0 && vCount != 0 && xCount != 0)
            {
                byte offset = 0;
                this.vBuffer.position(offset);
                GL11.glVertexPointer(3, vsize, 0, this.vBuffer.asFloatBuffer());
                ...
                if (this.hasNormal)
                {
                    ...
                    GL11.glNormalPointer(vsize, 0, this.vBuffer.asFloatBuffer());
                ...
                {
                    this.vBuffer.position(offset1);
                    GL11.glColorPointer(4, vsize, 0, this.vBuffer);
                ...
                {
                    this.vBuffer.position(offset1);
                    GL11.glTexCoordPointer(2, vsize, 0, this.vBuffer.asFloatBuffer());
